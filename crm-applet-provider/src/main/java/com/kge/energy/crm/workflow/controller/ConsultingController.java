...
public class ConsultingController {
    ...
    @ConvertToGoFormats
    public CommonResponse getFormPage(@RequestBody @Valid WfFormReq req) {
    ...
    @ConvertToGoFormats
    public CommonResponse<PageResp<WfFormResp>> getByPage(@RequestBody WfFormReq req){
        return CommonResponse.suc(consultingService.getByPage(req));
    }
