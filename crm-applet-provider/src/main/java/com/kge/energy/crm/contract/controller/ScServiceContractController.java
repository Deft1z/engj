...
public class ScServiceContractController {
    ...
    @ConvertToGoFormats
    public CommonResult<PageResp<ScServiceContractResp>> getPage(@Validated @RequestBody ScServiceContractPageReq req) {
    ...
    public CommonResult<ServiceContractResp> getContractDetailByContractId(@Validated @RequestBody ServiceContractDetailReq req) {
    ...
    @ConvertToGoFormats
    public CommonResult<List<ServiceContractResp>> getContractByFormId(@Validated @RequestBody ServiceContractReq req) {
    ...
    @Operation(summary = "更新合同项目开工竣工时间")
